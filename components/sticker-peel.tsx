...
//   overrides={{"image":{"src":"https://imagedelivery.net/IEUjvl3YUlxY-MrTpOAWDQ/cbf541e7-a558-45e7-11e8-7e63e9d1a800/w=800"},"shadow":{"x":-300,"y":140,"color":"#000000","opacity":30},"backColor":"#000000","hoverPeel":45,"pressPeel":64,"imageWidth":200,"transition":{"ease":"easeInOut","mass":1,"type":"tween","damping":60,"duration":0.6,"stiffness":800},"imageHeight":200,"curlRotation":240,"shadowEnabled":true}}
//   __curationVersion={1}
"use client";
 ...
 * @framerDisableUnlink
 */
export default function StickerPeeling({
    image,
    imageWidth = 200,
    imageHeight = 200,
    curlRotation = 240,
